...
const UpdateCustomer = ({ token }: { token: string }) => {
  ...
  }, [API_URL, customerId, token, reset])
              ...
              <Grid item xs={12} sm={6}>
                <Controller
                  ...
                  rules={{
                    pattern: {
                      value: /^[0-9]{10}$/,
                      message: 'Enter valid 10 digit whatsaap number'
                    }
                  }}
                  render={({ field }) => (
                    <CustomTextField
            ...
            <Grid container spacing={4}>
              ...
              <Grid item xs={12} sm={6}>
                <Controller
                  ...
                  control={control}
                  rules={{
                    required: 'Sales Team Pax is required',
                    pattern: {
                      value: /^[0-9]+$/,
                      message: 'Only numbers allowed'
                    }
                  ...
                  render={({ field }) => (
                    <CustomTextField
                      {...field}
                      label='Sales Team Pax*'
                      fullWidth
                      placeholder='e.g. 250'
                      error={!!errors.salesTeamPax}
                      helperText={errors.salesTeamPax?.message}
                    />
                  )}
                />
              </Grid>
              ...
              <Grid item xs={12} sm={6}>
                <Controller
                  ...
                  render={({ field }) => (
                    <CustomTextField
                      {...field}
                      label='Import Volume / Month'
                      fullWidth
                      placeholder='% e.g. 30'
                      error={!!errors.importVolume}
                      helperText={errors.importVolume?.message}
                    />
                  )}
                />
              </Grid>
              ...
              <Grid item xs={12} sm={6}>
                <Controller
                  name='importingSince'
                  control={control}
                  rules={{ required: 'Importing since date is required' }}
                  render={({ field }) => (
                    <AppReactDatepicker
                      selected={field.value}
                      onChange={field.onChange}
                      customInput={
                        <CustomTextField
                          ...
                          error={!!errors.importingSince}
                          helperText={errors.importingSince?.message}
                        />
                      }
                    />
                  )}
